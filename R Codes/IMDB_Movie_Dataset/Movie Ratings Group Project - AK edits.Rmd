...
*Note: The SD decreases as n increases, so unsure if this is a fair deduction*
...
*Documentary hsa the higher confidence interval, with overlaps with War, Film-Noir, and Animation. One of these four is most likely the highest rating genre. Horror is the lowest rating genre by far, with no overlap with any other genres.*
